...
@section("title","Your Exam Categories")
@section('content')
    ...
    <div class="container page__container page-section">
        ...
        <div class="card dashboard-area-tabs p-relative o-hidden mb-lg-32pt">
            <div class="card-header">
                <a href="{{route("instructor.exams.categories.create")}}" class="btn btn-primary">Create new category</a>
            </div>
            <div class="table-responsive">
                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    ...
                    <tr class="pr-0">
                        ...
                        <td><img src="{{asset("assets/exam_categories/image/".$category->image)}}" height="50px" width="50px" alt="{{$category->name}} logo"/></td>
                        <td>{{$category->name}}</td>
                        <td>
                            <form action="{{route("instructor.exams.categories.delete")}}" method="post">
                                @csrf
