...
<div class="container page__container page-section pb-0">
    ...
    <div class="container page__container page-section">
        ...
        <div class="page-separator">
            <div class="page-separator__text">Create a questionair form for {{$webinar->title}}</div>
        </div>
        <div id="form-builder"></div>
        <form action="{{route("instructor.webinars.form.create",$webinar->id)}}" onsubmit="fillContent(event);" method="post" enctype="multipart/form-data">
            @csrf
