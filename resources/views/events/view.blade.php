        ...
        <div class="row p-4">
            <div class="col-lg-9">
                <ul class="nav text-uppercase nav-tabs">
                   ...
                   @auth @if(Auth::user()->enrolled_events->where("event_id",$event->id)->first()!==NULL)<li class="nav-item"><a href="#" data-target="#documents" data-toggle="tab" class="nav-link text-capitalize">Documents & References</a></li>@endif @endauth
                ...
                <div class="tab-content mt-3">
                   ...
                   <div id="documents" class="tab-pane fade">
                       <div class="card">
                           ...
                           <div class="card-body">
                               <div class="row">
                                   @foreach ($event->documents as $key => $document)
                                       <div class="col-lg-12">
