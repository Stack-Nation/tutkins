...
<div class="bg-primary pb-lg-64pt py-32pt">
    <div class="container page__container">
        <h1 class="text-white flex m-0">{{ $course->content->{array_keys($content)[$section_id]}->content[$lecture_id]->lecture_title }} Result</h1>
        <br><hr>
        <h3 class="text-white text-center">
            {{$marks}}/{{count($course->content->{array_keys($content)[$section_id]}->content[$lecture_id]->data)}}
        </h3>
    </div>
</div>
