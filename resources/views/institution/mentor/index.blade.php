            ...
            <div class="table-responsive">
                ...
                <table class="table mb-0 thead-border-top-0 table-nowrap">
                    ...
                    <tr class="pr-0">
                        ...
                        <td>
                            <form action="{{route("institution.mentors.delete")}}" method="post">
                                @csrf
...
<form action="{{route("institution.mentors.create.bulk")}}" enctype="multipart/form-data" method="post">
    @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('institution.mentors.create') }}">
                @csrf
